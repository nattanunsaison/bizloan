...
class BuyerReceiptExport implements FromView,WithDrawings,WithTitle,WithEvents,WithColumnWidths
{
    /**
    ...
    */
    ...
    {
        $record = $this->record;
        $amount_read = (new \App\Http\Controllers\ReportController)->Convert($record->receive_amount);
